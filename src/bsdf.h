 ...
 */
    ...
    public:
         ...
         */
        virtual Spectrum sample_f(const Vector3D &wo, Vector3D *wi, double *pdf) = 0;
 ...
 */
    ...
    public:
        ...
        MicrofacetBSDF(const Spectrum &eta, const Spectrum &k, double alpha)
 ...
 */
    ...
    public:
        ...
        RefractionBSDF(const Spectrum &transmittance, double roughness, double ior)
