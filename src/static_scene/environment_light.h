...
// image. This is commonly used for low-cost renderings of complex backgrounds or
// environments (fancy church, overgrown forest, etc) that would be difficult to
// model in the scene.
        class EnvironmentLight : public SceneLight {
        public:
            EnvironmentLight(const HDRImageBuffer *envMap, bool env_hemisphere_sample=false);
